...
- **Hover Popup pattern (mousemove + persistent popup)**: [Display a popup on hover](https://github.com/maplibre/maplibre-gl-js/blob/main/test/examples/display-a-popup-on-hover.html)
- **Click Popup pattern**: [Display a popup on click](https://github.com/maplibre/maplibre-gl-js/blob/main/test/examples/display-a-popup-on-click.html)
- **Live data updates** (use `setData` on GeoJSON sources): [Large data guide](https://github.com/maplibre/maplibre-gl-js/blob/main/docs/guides/large-data.md)
